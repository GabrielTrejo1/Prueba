...
class Vehiculos():
    ...
    def nuevo_vehiculo(self):
        try:
            ...
            patente = self.vehiculo.txtPatente.text()

            query = ("INSERT INTO Vehiculos (marca, modelo, motor, color, carroceria, tipo_combustible, detalles, patente)"
                     " VALUES(?,?,?,?,?,?,?,?)")
            valores = (marca, modelo, motor, color, carroceria, combustible, detalles, patente)
    ...
    def buscar_vehiculo(self):
        try:
            ...
            query = "SELECT * FROM Vehiculos WHERE Marca LIKE %s OR Modelo LIKE %s"
